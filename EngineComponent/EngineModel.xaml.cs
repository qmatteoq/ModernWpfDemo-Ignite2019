...
{
    public sealed partial class EngineModel : UserControl
    {
        ...
        public Uri ModelUrl
        {
            get { return (Uri)GetValue(ModelUrlProperty); }
            set { SetValue(ModelUrlProperty, value); }
        }

        // Using a DependencyProperty as the backing store for ModelUrl.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty ModelUrlProperty =
            DependencyProperty.Register("ModelUrl", typeof(Uri), typeof(EngineModel), new PropertyMetadata(0));
